...
public class UpdateProfile extends HttpServlet {
	...
	try {
			...
			else 
			{
				...
				String filePath = "C:\\Users\\melro\\Downloads\\EmployeeTalentPortal-main\\EmployeeTalentPortal-main\\src\\main\\webapp\\assets\\resume\\"+email+"_"+update_resume ;
	            for (Part part : resume) 
	            {
	              System.out.println(part.getName());
	              part.write("C:\\Users\\melro\\Downloads\\EmployeeTalentPortal-main\\EmployeeTalentPortal-main\\src\\main\\webapp\\assets\\resume\\"+email+"_"+update_resume );
	            }
			}
			...
			else
			{
				...
				String filePath2 = "C:\\Users\\melro\\Downloads\\EmployeeTalentPortal-main\\EmployeeTalentPortal-main\\src\\main\\webapp\\assets\\images\\"+email+"_"+update_photo ;
	            for (Part part : image) 
	            {
	              part.write("C:\\Users\\melro\\Downloads\\EmployeeTalentPortal-main\\EmployeeTalentPortal-main\\src\\main\\webapp\\assets\\images\\"+email+"_"+update_photo );
	            }	
			}   
