...
public class Register extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
            ...
            String filePath = "C:\\Users\\melro\\Downloads\\EmployeeTalentPortal-main\\EmployeeTalentPortal-main\\src\\main\\webapp\\assets\\resume"+email+"_"+fileName ;
            for (Part part : request.getParts()) 
            {
              part.write("C:\\Users\\melro\\Downloads\\EmployeeTalentPortal-main\\EmployeeTalentPortal-main\\src\\main\\webapp\\assets\\resume"+email+"_"+fileName );
            }
